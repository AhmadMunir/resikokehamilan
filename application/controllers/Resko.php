	...
	*/
	...
	public function index()
	{
	 ...
	 public function import(){
	    ...
	    $loadexcel = $excelreader->load('excel/data_training.xlsx'); // Load file yang telah diupload ke folder excel
	    ...
	    foreach($sheet as $row){
	      ...
	      if($numrow > 1){
	        ...
	        array_push($data, array(
	          'id_skrining'=>$row['A'], // Insert data nis dari kolom A di excel
	          'id_bumil'=>$row['B'], // Insert data nama dari kolom B di excel
	          'id_pgw'=>$row['C'], // Insert data jenis kelamin dari kolom C di excel
	          'usia16'=>$row['D'], // Insert data alamat dari kolom D di excel
	          'usia'=>$row['E'], // Insert data alamat dari kolom D di excel
	          'jp1'=>$row['F'], // Insert data alamat dari kolom D di excel
	          'jhkehamil'=>$row['G'], // Insert data alamat dari kolom D di excel
	          'jumlahanak'=>$row['H'], // Insert data alamat dari kolom D di excel
	          'tb_bumil'=>$row['I'], // Insert data alamat dari kolom D di excel
	          'pkguguran'=>$row['J'], // Insert data alamat dari kolom D di excel
	          'pmdengan'=>$row['K'], // Insert data alamat dari kolom D di excel
	          'pocesar'=>$row['L'], // Insert data alamat dari kolom D di excel
	          'pykt_bumil'=>$row['M'], // Insert data alamat dari kolom D di excel
	          'jnshamil'=>$row['N'], // Insert data alamat dari kolom D di excel
	          'bayimatikndgn'=>$row['O'], // Insert data alamat dari kolom D di excel
	          'lebihbln'=>$row['P'], // Insert data alamat dari kolom D di excel
	          'letjanin'=>$row['Q'], // Insert data alamat dari kolom D di excel
	          'pendarahan'=>$row['R'], // Insert data alamat dari kolom D di excel
	          'preeklamsia'=>$row['S'], // Insert data alamat dari kolom D di excel
	          'statusres'=>$row['T'], // Insert data alamat dari kolom D di excel
	        ));
	      }
	 ...
	 public function form(){
	    ...
	    if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
	      ...
	      if($upload['result'] == "success"){ // Jika proses upload sukses
	        ...
	        $excelreader = new PHPExcel_Reader_Excel2007();
	        $loadexcel = $excelreader->load('excel/data_training.xlsx'); // Load file yang tadi diupload ke folder excel
	        $sheet = $loadexcel->getActiveSheet()->toArray(null, true, true ,true);
